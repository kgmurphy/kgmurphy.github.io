...
// 7. When radio button is chosen --> show the hair
    ...
    for(let ah of hair_radios){
        ah.addEventListener('click', function(){
            let hair_Id = ah.getAttribute('id');  
            if
            ...
            (hair_Id ==  'hairstyle_5_radio'){
                //hideAllHair();// hide all the hairs except this one
                for(let i = 0; i < all_hairs.length; i++){
                    all_hairs[i].style.visibilty = 'hidden';
                }
            }
